...
// NewHTTPError creates a new ProblemDetails error based just the HTTP Status Code and Error message
func NewHTTPError(statusCode int, err error) *ProblemDetails {
	return New(statusCode, "", "", err.Error(), "")
}
